import { Bot, Bottleneck, Composer, I18n, session, logger, InlineQueryResult, parseMode, enhanceStorage, MemorySessionStorage, Enhance } from './deps.ts';
import { EmptySessionContext, MediaContext, MediaSessionData, MyContext } from './types/context.ts';
...
bot.use(session({
    ...
    current: {
        ...
        storage: enhanceStorage({
            storage: new MemorySessionStorage<Enhance<MediaSessionData['current']>>(),
